"""
Django settings for artik_44154 project.
...
WSGI_APPLICATION = 'artik_44154.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "artik_44154 API",
    "DESCRIPTION": "API documentation for artik_44154 App",
    "VERSION": "v1",
}
